...
public class SpringApplication {
    ...
    public static void run(Object object,String... args) {
        try {
            ...
            //Class文件读取地址
            File additionWebInfoClasses = new File("springDiscuss/target/classes");
            //创建WebRoot
            WebResourceRoot resource = new StandardRoot(scx);
            //tomcat内部读取Classes文件
            resource.addPreResources(new DirResourceSet(resource,"/springDiscuss/WEB-INF/classes",additionWebInfoClasses.getAbsolutePath(),"/"));
            tomcatServer.start();
            //异步等待请求执行
